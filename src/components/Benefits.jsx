...
export default function Benefits() {
  ...
  return (
    <section className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-50/60 rounded-full blur-3xl pointer-events-none" />
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map(({ value, label }, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl p-5 border border-gray-100 shadow-card hover:border-blue-100 hover:shadow-card-lg hover:-translate-y-0.5 transition-all duration-300"
          ...
          >
            {benefits.map(({ icon: Icon, title, text }, i) => (
              <div
                ...
                style={{ transitionDelay: `${i * 80}ms` }}
              >
                <div className="shrink-0 w-10 h-10 rounded-xl bg-blue-50 text-blue-700 flex items-center justify-center mt-0.5 group-hover:bg-blue-700 group-hover:text-white transition-all duration-300">
                  <Icon size={18} />
                </div>
                <div>
