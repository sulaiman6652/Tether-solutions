...
function SystemVisual() {
  return (
    <div className="relative w-full max-w-md mx-auto lg:mx-0">
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-5 space-y-3">
        ...
        {[
          ...
          <div key={i} className="relative">
            ...
            <div className="relative z-10 flex items-center gap-3 bg-gray-50/70 rounded-xl px-3.5 py-2.5 border border-gray-100">
      ...
      <div className="absolute -top-4 -right-4 bg-white rounded-xl shadow-lg border border-gray-100 px-3.5 py-2.5">
        ...
        <p className="text-xl font-extrabold text-blue-700 mt-0.5">12+ <span className="text-xs font-normal text-gray-400">hrs</span></p>
      </div>

      <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg border border-gray-100 px-3.5 py-2.5 flex items-center gap-2">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-[52px] font-extrabold leading-[1.1] tracking-tight text-gray-900">
                The Business{' '}
