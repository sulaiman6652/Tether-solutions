import { ArrowRight, CheckCircle2, Zap, Calendar, Users, BarChart2, Clock } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="space-y-4">
              <h1 className="text-[2.6rem] leading-[1.08] sm:text-5xl lg:text-5xl xl:text-[52px] font-extrabold tracking-tight text-gray-900">
              ...
              <p className="text-gray-500 text-sm leading-relaxed max-w-lg">
                For businesses tired of missed enquiries, manual admin, slow follow-ups, and messy workflows — I build simple systems that help you run smoother and grow faster.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 pt-2 lg:hidden">
              {[
                { icon: Users,    value: 'Done', label: 'For you' },
                { icon: Clock,    value: '1–2w',  label: 'To build' },
          ...
          {/* Visual — desktop only */}
          <div className="hidden lg:flex justify-center lg:justify-end mt-4 lg:mt-0">
            <SystemVisual />
          </div>
